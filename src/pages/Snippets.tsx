    ...
    <>
      ...
      <Card>
        ...
        <CardBody>
          ...
          {(!loadingSnippets && snippets.length === 0) && <Text>{__('No snippets found', 'codewpai')}</Text>}
            ...
            <table className="wp-list-table widefat fixed striped">
              ...
              {snippets.map((snippet) => (
                <>
                  ...
                  {snippet.error && <tr style={{backgroundColor: '#FFDCDC'}}>
                    <td colSpan={3}>
                      <Text as='div'>
                        <strong>{__('This snippet has been disabled because it trows a fatal error:', 'codewpai')}</strong>
                      </Text>
                      <Text>- {snippet.error.message} on <span style={{color: '#696969'}}>{snippet.error.file}:{snippet.error.line}</span></Text>
                    </td>
                  </tr>}
                </>
              ))}
