...
export const RepeatedForm = () => {
	...
	return (
		<Card>
			<CardHeader>
				<Heading>{__('Repeated Form', 'wp-cwpai-settings-page-boilerplate')}</Heading>
			</CardHeader>
			<CardBody>
				<Disabled isDisabled={isSaving}>
					<TextControl
						...
						label={__('Label Text', 'wp-cwpai-settings-page-boilerplate')}
						onChange={nameChanged}
						value={name}
					/>

					<BaseControl
						label={__('Widgets', 'wp-cwpai-settings-page-boilerplate')}
							...
							<CardFooter>
								<Flex>
									...
									<Button variant="secondary" onClick={addItem}>
										{__('Add Item', 'wp-cwpai-settings-page-boilerplate')}
									</Button>
								</Flex>
							</CardFooter>
						</Card>
			...
			<CardFooter className="components-card-footer--sticky">
				<Flex>
					<Button variant="tertiary" onClick={resetForm} disabled={isSaving}>
						{__('Reset', 'wp-cwpai-settings-page-boilerplate')}
					</Button>
					<Button variant="primary" onClick={doSave} disabled={isSaving}>
						{__('Save', 'wp-cwpai-settings-page-boilerplate')}
					</Button>
				</Flex>
			</CardFooter>
		</Card>
